...
> **Status: phase 8 (Payments) complete.** Next: phase 9, the order management dashboard.
...
proves cross-tenant reads and writes return nothing — 302 assertions, run in CI on
