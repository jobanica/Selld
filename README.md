...
> **Status: phase 9 (Order management) complete.** Next: phase 10, courier integration.
...
proves cross-tenant reads and writes return nothing — 334 assertions, run in CI on
